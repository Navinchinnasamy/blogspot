                    ...
                    <div class="tabs-section">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade in active" id="tab-1">
                                <p><strong class="accent-color">Sed ut perspiciatis</strong> unde omnis iste natus error
                                    sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae
                                    ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explica.
                                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia
                                    consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. But I must
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="icons-list">
                                            <li><i class="fa fa-check-circle"></i> Duis aute irure dolor in
                            ...
                            <div class="tab-pane fade" id="tab-2">
                                <p><img class="img-thumbnail image-text" style="float:left; width:180px;" alt=""
                                        src="images/bussniss-pic.jpg"/></p>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi
                                    architecto beatae vitae dicta sunt explica. Nemo enim ipsam voluptatem quia voluptas
                                    sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui
                                    ratione voluptatem sequi nesciunt. But I must explain to you how all this mistaken
                                    ...
                                    do not know how to pursue pleasure rational encounter consequences that are
                                    extremely painful.</p>
                                <p>But I must explain to you how all this mistaken idea of denouncing pleasure and
                                    praising pain was born and I will give you a complete account of the system, and
                                    expound the actual teachings of the great explorer of the truth, the master-builder
                                    of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it
                                    is pleasure, but because those who do not know how to pursue pleasure rational
                                    encounter consequences that are extremely painful.</p>
                            </div>
                            <!-- Tab Content 3 -->
                            <div class="tab-pane fade" id="tab-3">
                                <p><strong>Lorem ipsum</strong> dolor sit amet, consectetur adipisicing elit, sed do
                                ...
                                <p>But I must explain to you how all this mistaken idea of denouncing pleasure and
                                    ...
                                    because occasionally circumstances occur in which toil and pain can procure.</p>
                            </div>
                        </div>
                        <!-- End Tab Panels -->
...
<!-- Style Switcher -->
<?php require_once("switcher.html"); ?>
