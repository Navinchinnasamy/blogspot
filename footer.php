...
<footer>
    <div class="container">
        <div class="row footer-widgets">
            ...
            <div class="col-md-3 col-xs-12">
                <div class="footer-widget twitter-widget">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><a href="#">@GrayGrids </a> Lorem ipsum dolor et, consectetur adipiscing eli.An Fusce
                                eleifend aliquet nis application.</p>
            ...
            <div class="col-md-3 col-xs-12">
                <div class="footer-widget contact-widget">
                    ...
                    <p>We consider it, however, worthy of those who hate them, and they are bringing against the
                        blandishments of the present pleasures, and the righteous deleniti blinded and corrupted by the
                        desire of these pains, and which are not provident troubles excepturi</p>
                    <ul>
                        <li><span>Phone Number:</span> +91 80 122 89528</li>
                        <li><span>Email:</span> navinchinnasamy@gmail.com</li>
                        <li><span>Website:</span> www.navinplaying.000webhost.com</li>
                    </ul>
                </div>
            </div>
            <!-- .col-md-3 -->
        ...
        <div class="copyright-section">
            <div class="row">
                <div class="col-md-6">
                    <p>&copy; 2016 Navin - All Rights Reserved <a href="http://www.navinplaying.000webhost.com">NavinPlaying</a>
                    </p>
                </div>
                <!-- .col-md-6 -->
                <div class="col-md-6">
